...
export const Show = () => {
  ...
  const deleteHeroe = async (id) => {
    ...
    //getHeroes();  //invocar a la funcion
    //
  };
  ...
  //tarea: realizar cambios correspondientes para que la lista de heroes se actualice cada vez que elimino uno,
  // evitando invocar a la funcion en deleteHeroe
